          ...
          <div className='py-5 h-100vh mt-20'>
            <div className={classNames("flex flex-col lg:flex-row justify-between items-center mx-auto max-w-[1114px] px-4", styles.animate)}>
              <div className='flex flex-col items-center lg:items-start'>
                ...
                <h2 className='font-bold text-4xl lg:text-6xl text-center sm:text-start my-6'>Full Stack Developer</h2>
              ...
              <img src="/dev-coding.webp" alt="codando" className={styles.animate} />
